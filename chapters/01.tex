...
\begin{forest}
[DP[SpecDP][$\overline{\textrm{D}}$ [D\textdegree [These]][NumP[AdvP[three,roof]][$\overline{\textrm{Num}}$[Num\textdegree][EvalP[AdvP[beautiful,roof]][$\overline{\textrm{Eval}}$[Eval\textdegree][SizeP[AdvP[huge,roof]][$\overline{\textrm{Size}}$[Size\textdegree][AgeP[AdvP[old,roof]][$\overline{\textrm{Age}}$[Age\textdegree][ShapeP[AdvP[round,roof]][$\overline{\textrm{Shape}}$[Shape\textdegree][ColorP[AdvP[brown,roof]][$\overline{\textrm{Color}}$[Color\textdegree][NP[rugs,roof]]]]]]]]]]]]]]]]
%[NP [AdjP [cute, roof]] [NP[AdjP [tiny, roof]][NP[SpecNP][$\overline{\textrm{N}}$ [{N\textdegree}[kitten]] [{\phantom{N}}] ]]]]
\end{forest}}
\end{exe}
