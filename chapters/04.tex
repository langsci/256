...
As famously argued in \citet{cinque1999adverbs}, however, this prediction is not accurate. \citet[5--6]{cinque1999adverbs}, for example, illustrates that the Italian adverbs \textit{mica} `not', \textit{pi\`{u}} `any longer', and \textit{sempre} `always' cannot be ordered freely, but exhibit rigid ordering restrictions. First, consider the order of \textit{mica} and \textit{pi\`{u}}:

\begin{exe} 
\ex Italian \citep[5]{cinque1999adverbs} \label{cinqueonadverborderingbiga} \begin{xlist} 
\ex \gll {\textit{Non}} {\textit{hanno}} {\textit{chiamato}} {mica} {pi\`{u},} {\textit{da}} {\textit{allora}.}  \\
...
\ex \gll \llap{$^*$}{\textit{Non}} {\textit{hanno}} {\textit{chiamato}} {pi\`{u}} {mica,} {\textit{da}} {\textit{allora}.}  \\
...
\textit{mica} $>$ \textit{pi\`{u}} $>$ \textit{sempre}
\end{exe}
...
adverbs, or pragmatic adverbs (e.\,g., Jackendoff 1972; Bellert 1977), in Cinque's system, the term is used to refer to adverbs like \textit{frankly} or \textit{honestly} that characterize the speaker's state-of-mind concerning the assertion. As they qualify assertions, speech-act adverbs take very wide scope.
...
\begin{figure}[bt]
\centering
	\includegraphics[width=1.0\textwidth]{honestly.jpg}
...
\begin{figure}[bt]
\centering
	\includegraphics[width=1.0\textwidth]{mirative-nnmtwo.jpg}
...
%%\glll {\hspace{30pt}{}}  {\hspace{27pt}${\hspace{33pt}\underline{\textrm{\quad hn + ec}}}$} \\
%\ex
%{\hspace{102pt}mirative}  \\
%{$\overline{\textrm{\textsc{paul computer new buy}}}$}   
\glt `Surprisingly, Paul bought a new computer.'\label{ex:mirativitydgsa}
\ex \slgl[mirative]{surprisingly, paul computer new buy}
%\ex
%{\hspace{186pt}mirative}  \\
%{$\overline{\textrm{\textsc{surprisingly, paul computer new buy}}}$}   
...
\begin{figure}[bt]
\centering
	\includegraphics[width=1.0\textwidth]{evalbad.jpg}
...
\begin{figure}[bt]
\centering
	\includegraphics[width=1.0\textwidth]{evalgoodnew.jpg}
...
\begin{figure}[bt]
\centering
	\includegraphics[width=1.0\textwidth]{allegedly-evidential3.jpg}
...
\begin{theo}[Modal Force, Modal Flavor, and Modal Anchor]\vspace{-0.3cm}
...
A similar argument can be made with the scopal interaction of modals and negation. In German, for example, \textit{m\"ussen} takes scope above negation in an epistemic interpretation, while the same modal scopes below negation in a deontic reading as illustrated in (\ref{scopalinteractionnegmodal}).
...
%\glll {\hspace{30pt}{}}  {\hspace{27pt}${\hspace{33pt}\underline{\textrm{\quad hn + ec}}}$} \\
%{\hspace{120pt}epistemic}  \\
%{$\overline{\textrm{\textsc{(possibly) swen work}\textsubscript{3a} \textsc{go}\textsubscript{3a}}}$}     
\glt `Swen could be off to work.'\label{epistemichappa}
\ex \slgl[epistemic:sure]{(surely) swen work go}
%{\hspace{110pt}epistemic}  \\
%{$\overline{\textrm{\textsc{(surely) swen work}\textsubscript{3a} \textsc{go}\textsubscript{3a}}}$}     
...
\begin{figure}[bt]
\centering
	\includegraphics[width=1.0\textwidth]{probably.jpg}
...
\begin{figure}[bt]
\centering
	\includegraphics[width=1.0\textwidth]{epistemicobvious.jpg}
...
\ex \gll{\textcolor{white}{`}$[$\dots $]$} {\textit{dass}} {\textit{G\"okce}} {(wahrscheinlich)} {\textit{davor}} {(wahrscheinlich)} {\textit{zuhause}} {\textit{war}}.\\
{\textcolor{white}{`}$[$\dots $]$} {that} {G\"okce} {probably} {before} {probably} {at.home} {was}\\
\trans `$[$\dots $]$ that before that G\"okce was probably at home.' \label{spokengermantemporalprobalbyperhapsa}
\ex \gll{\textcolor{white}{`}$[$\dots $]$} {\textit{dass}} {\textit{G\"okce}} {(vielleicht)} {\textit{davor}} {(vielleicht)} {\textit{zuhause}} {\textit{war}}.\\
{\textcolor{white}{`}$[$\dots $]$} {that} {G\"okce} {perhaps} {before} {perhaps} {at.home} {was}\\
\trans `$[$\dots $]$ that before that G\"okce was perhaps at home.' \label{spokengermantemporalprobalbyperhapsb}
\end{xlist}
\end{exe}
...
\begin{figure}[bt]
\centering
	\includegraphics[width=1.0\textwidth]{probablyperhaps2.jpg}
...
According to \citet[78]{cinque1999adverbs} alethic modality, a term introduced by Wright (1951),\footnote{ The terms `epistemic', `deontic' and `dynamic' are also from \citet{von1951essay}.} is a modal flavor concerned with
...
\section{Scalarity Little/Much (\textit{little}/\textit{much})}\label{scalarity}\is{scalarity|(}
...
\begin{figure}[bt]
\centering
	\includegraphics[width=1.0\textwidth]{evalmuch.jpg}
...
\begin{exe}
\ex \slg{paul always shortly} \slg[$==$]{visit}
 %{}  {\hspace{142pt}$==$}  \\
%{\textsc{\textsc{paul always shortly}}} {$\overline{\text{\textsc{visit}}}$}      
...
\begin{figure}[bt]
\centering
	\includegraphics[width=1.0\textwidth]{littlemuchlion2.jpg}
...
In the next section, I will discuss the different meaning contributions of the manual and non-manual expression of the categories discussed so far. Then, I will continue discussing Tense and the categories below it.
...
%
%
%{\hspace{93pt}\textcolor{white}{hs}} \hspace{45pt}hs \hspace{26pt}hs \hspace{187pt}hn  \\
%B: \textsc{$\overline{\textrm{true-neg}}$. \#$\overline{\textrm{neg}}$ surprising. index}\textsubscript{2} \textsc{already $\overline{\textrm{know}}$}\\
...
\ex B: \slg[hs]{true-neg}. \slg[hs]{neg} \slg{surprising. index_2 already} \slg[hn]{know}\\
%{\hspace{103pt}\textcolor{white}{hs}} \hspace{53pt}hs \hspace{17pt}hs \hspace{186pt}hn  \\
%B: \textcolor{white}{\#}\textsc{$\overline{\textrm{true-neg}}$. $\overline{\textrm{neg}}$ surprising. index}\textsubscript{2} \textsc{already $\overline{\textrm{know}}$}\\
\textcolor{white}{A: }`That's not true. That's not surprising. You already knew that.'
...
\begin{theo}[Commonalities Between Tenseless Languages]\vspace{-0.3cm}
...
\glt `By next year, Maria must be able to do ride a bike.'\label{deonticexamplesdgscombininga}}
...
\glt `By next year, Maria must be able to do ride a bike.'\label{deonticexamplesdgscombiningblaa}}
...
\glt `By next year, Maria must be able to do ride a bike.'\label{deonticexamplesdgscombiningblaaa}}
...
\begin{exe}
\ex\label{treeoverviestwo}
\begin{minipage}[t]{\linewidth}
          \raggedright
          \adjustbox{valign=t}{%
            \includegraphics[width=0.8\linewidth]{treesimple.jpg}%
          }
...
\noindent It has to be noted, however, that the expression of predispositional aspect has been described as being expressed by changing the movement path of the verb sign for some sign languages. Most notably, \citet[249]{klima1979signs} claim that a large, circular \is{reduplication}reduplication of the verb sign indicates predispositional aspect which they paraphrase with \textit{tend to} in American Sign Language (see also \citealt{rathmann2005event}). However, this modulation is only possible for a very restricted set of signs referring to incidental or temporary states (e.\,g., \textsc{angry}, \textsc{sick}, or \textsc{dirty}). I have not made a similar observation for DGS, although I do not exclude the possibility that this is possible for a restricted class of verbs.  
...
\ex {\textcolor{white}{*}\textsc{paul usually often at-home}}
...
\ex {\textcolor{white}{*}\textsc{now paul again often beer buy}}
...
\vspace{-0.5cm}
\section{Tense Anterior (\textit{already})}\is{tense anterior|(}
\subsection{General Overview}
...
\glt \textcolor{white}{*?}`Gianni still always wins the game.' \label{ex:perfecta}}
...
\begin{figure}[bt]
\centering
	\includegraphics[width=1.0\textwidth]{just2.jpg}
...
\noindent Combining durative\is{durative aspect} aspect and prospective aspect gives the expected result (durative apsect $>$ prospective aspect), as illustrated in (\ref{durativeprospectivedgs}).
...
\begin{figure}[bt]
\centering
	\includegraphics[width=1.0\textwidth]{modaldoubling.jpg}
...
\begin{figure}[bt]
\centering
	\includegraphics[width=1.0\textwidth]{completive.jpg}
